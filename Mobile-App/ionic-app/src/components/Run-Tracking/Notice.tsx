      ...
      <IonContent fullscreen className="inrun-container">
        ...
        <div className="overlay">
          ...
          <div className="notice-buttons">
            <IonButton expand="block" className="notice-btn red">
              TRAFFIC NOTICE
            </IonButton>
            <IonButton expand="block" className="notice-btn orange">
              HAZARD NOTICE
            </IonButton>
            <IonButton expand="block" className="notice-btn green">
              REPORT HAZARD
            </IonButton>
          </div>
        </div>
        ...
        <div className="bottom-actions">
          <IonButton shape="round" className="stop-btn">
            STOP
          </IonButton>
