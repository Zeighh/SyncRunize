...
import { notifications, search, homeOutline, mapOutline, peopleOutline, calendarOutline, analyticsOutline } from "ionicons/icons";
    ...
    <IonPage className="analytics-page">
      ...
      <IonHeader className="dashboard-header">
        <IonToolbar className="dashboard-toolbar">
          ...
          <IonButtons slot="end">
            <IonButton routerLink="/HomeModule/homeM3/index.html">
              <IonIcon className="header-icon" icon={notifications} />
            </IonButton>
            <IonButton>
              <IonIcon className="header-icon" icon={search} />
            </IonButton>
            <IonButton routerLink="/UserProfile/userP1/index.html">
        ...
        <IonCard className="leaderboard-card">
          <IonCardContent>
            ...
            <IonList className="leaderboard-list">
              <IonItem className="leaderboard-item">
            ...
            <div className="view-more">View Full Leaderboard</div>
          </IonCardContent>
        </IonCard>
      </IonContent>
    </IonPage>
